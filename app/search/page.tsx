        ...
        <Card className="border-gray-800 bg-gradient-to-br from-gray-900/80 to-black/80 backdrop-blur-xl shadow-2xl">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              <Label htmlFor="search-input" className="text-gray-300 text-lg flex items-center gap-2">
            ...
            {/* URL Search */}
            <div className="space-y-4">
              <Label htmlFor="url-input" className="text-gray-300 text-lg flex items-center gap-2">
